...
$approved = $result1->num_rows;
 ...
 <html>
 <head>
   <title> Learn It | Questions </title>
   <link rel="stylesheet" href="css/professor_questions.css">
 ...
 <body>
     ...
     <div id="MainScreen">
       ...
       <button id="NewQuestion"> Add a New Question </button>
       <button id="StudentQuestions"> Student Questions > </button>
       <script>
       $('#StudentQuestions').click(function(){
           window.location.href='studentQuestions.php';
       })
       $('#NewQuestion').click(function(){
           window.location.href='newQuestion.php';
       })
       </script>
       <ul id="List">
         <?php
             $id = $_SESSION['userId'];
             $sql = mysqli_query($connection, "SELECT * FROM question WHERE creatorId = $id");
